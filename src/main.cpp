...
unsigned int nStakeMinAge = 60 * 60 * 24 * 2;	// minimum age for coin age: 1h
unsigned int nStakeMaxAge = 60 * 60 * 24 * 90;	// stake age of full weight: 10 y
unsigned int nStakeTargetSpacing = 60;			// 60 sec block spacing

int64 nChainStartTime = 1590052738;
...
const string strMessageMagic = "TereSinaGoldCoin Signed Message:\n";
...
bool CBlock::ConnectBlock(CTxDB& txdb, CBlockIndex* pindex, bool fJustCheck)
{
    ...
    bool fEnforceBIP30 = true; // Always active in TereSinaGoldCoin
    bool fStrictPayToScriptHash = true; // Always active in TereSinaGoldCoin
...
bool CheckDiskSpace(uint64 nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "TereSinaGoldCoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        // Genesis block
        const char* pszTimestamp = "CBigNum vector TereSinaGoldCoin empty mapBlockIndex TereSinaGoldCoin TereSinaGoldCoin";
        CTransaction txNew;
       ...
       // printf("block.nNonce = %u \n", block.nNonce);
		block.print();
        assert(block.hashMerkleRoot == uint256("0x8d52781d7f4a07ab03b82da385efe55eb8bdbf6dff4be696e5635b1d9f5acc34"));
